...
public:
                       ...
                       void* vtkNotUsed(callData))
  {
    ...
    std::cout << this->TimerCount << std::endl; //Timer in console output.
    //actor->SetPosition(this->TimerCount, this->TimerCount, 0); //Actor position
    actor->RotateX(this->TimerCount);
    actor->RotateY(this->TimerCount);
...
int main(int, char*[])
{
  ...
  int timerId = renderWindowInteractor->CreateRepeatingTimer(300);
